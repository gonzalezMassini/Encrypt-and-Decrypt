...
//Enter the letter 'E' to encrypt message or the letter 'D' decrypt message: e
//Enter message to be encrypted: Winner unlucky dog, unlucky dog loser:)
//Enter any number form 0-9 as your key: 2
//Winner unlucky dog, unlucky dog loser:)
//\nssjw%zsqzhp~%itl1%zsqzhp~%itl%qtxjw?.
